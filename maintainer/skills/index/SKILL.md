...
| Choose installed EvoZeus product feature after install | local CLI product feature router | run `~/.evozeus/bin/evozeus features --json`, then `~/.evozeus/bin/evozeus capabilities --json` for risk and permission facts |
