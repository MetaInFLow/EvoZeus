...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default=8,
        type=int,
        help="Minimum sessions required for a project to appear in project insights.",
    )
    parser.add_argument(
        "--project-top-n",
        default=20,
        type=int,
        help="Top insight items per project in project insights.",
    )
    ...
    result = run_codex_official_visualization(
        ...
        project_min_sessions=args.project_min_sessions,
        project_top_n=args.project_top_n,
    ...
    print(f"project_insights_html={result.project_insights_html_path}")
    print(f"project_insights_projects={result.project_insights_project_count}")
    print(f"project_insights_sessions={result.project_insights_session_count}")
